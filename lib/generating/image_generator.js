...
ImageGenerator.prototype = {
    ...
    _svg2png: function (src, dest, options, callback) {
        var phantomjs2 = require.resolve('phantomjs2/bin/phantomjs'),
            sv2png = require.resolve('./phantom_scripts/svg2png.phantom.js');
        var width = options.width,
            height = options.height;
        execcli(phantomjs2, sv2png, src, dest, width, height, callback);
    },
    /**
     * Writeout an image.
